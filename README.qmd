...
- the `confidence_score` based on Jaro-Winkler similarity matching to for result ordering purposes
...
- `simililarity`: this is the similarity matching score based on Jaro-Winkler Similarity of the filtered results for ordering purposes
